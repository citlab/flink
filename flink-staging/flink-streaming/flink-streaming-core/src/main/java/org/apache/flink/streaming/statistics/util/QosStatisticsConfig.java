...
public class QosStatisticsConfig {
	 ...
	 */
	public static final String QOSMANAGER_OUTPUT_BATCHING_WEIGHT_KEY = "streaming.qosmanager.output_batching_latency_weight";
	 ...
	 */
	public static final String QOSMANAGER_SCALING_FITTING_FACTOR_DEVIATION_LIMIT_KEY = "streaming.qosmanager.scaling.fitting_factor_deviation_limit";
