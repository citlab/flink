...
public interface QosReportingReader {
	InputGateQosReportingListener getQosCallback(int index);

	void setQosCallback(InputGateQosReportingListener qosCallback, int index);
}
