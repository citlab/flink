...
public class DataStream<OUT> {
	...
	public DataStream<OUT> beginLatencyConstraint(long maxLatency) {
		return beginLatencyConstraint(maxLatency, false);
	}
	 ...
	 * @return The {@link DataStream}.
	 */
	public DataStream<OUT> beginLatencyConstraint(long maxLatency, boolean disableChaining) {
		return beginLatencyConstraint(new AutoGeneratedConstraintGroupIdentifier(), maxLatency, disableChaining);
	}
	...
	public DataStream<OUT> beginLatencyConstraint(String name, long maxLatency) {
		return beginLatencyConstraint(new NamedConstraintGroupIdentifier(name), maxLatency, false);
	}
	 ...
	 * @return The {@link DataStream}.
	 */
	public DataStream<OUT> beginLatencyConstraint(String name, long maxLatency, boolean disableChaining) {
		return beginLatencyConstraint(new NamedConstraintGroupIdentifier(name), maxLatency, disableChaining);
	}


	private DataStream<OUT> beginLatencyConstraint(ConstraintGroupIdentifier identifier, long maxLatency,
		...
		constraintGroupConfiguration.setChainingDisabled(disableChaining);
