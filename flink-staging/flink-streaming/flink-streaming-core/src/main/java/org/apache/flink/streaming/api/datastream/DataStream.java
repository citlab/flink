...
import org.apache.flink.streaming.api.constraint.identifier.AutoGeneratedConstraintGroupIdentifier;
...
public class DataStream<OUT> {
	 ...
	 * @return The {@link DataStream}.
	 */
	public DataStream<OUT> beginLatencyConstraintBefore(long maxLatency) {
		return beginLatencyConstraintBefore(maxLatency, false);
	}
	 ...
	 * @param maxLatency
	 * 		the desired maximum latency.
	 * @param disableChaining
	 * 		whether chaining over the constraint boundaries should be disabled.
	 * @return The {@link DataStream}.
	 */
	public DataStream<OUT> beginLatencyConstraintBefore(long maxLatency, boolean disableChaining) {
		return beginLatencyConstraintBefore(new AutoGeneratedConstraintGroupIdentifier(), maxLatency, disableChaining);
	}
	 ...
	 * @return The {@link DataStream}.
	 */
	public DataStream<OUT> beginLatencyConstraintBefore(String name, long maxLatency) {
		return beginLatencyConstraintBefore(new NamedConstraintGroupIdentifier(name), maxLatency, false);
	}
	 ...
	 * @return The {@link DataStream}.
	 */
	public DataStream<OUT> beginLatencyConstraintBefore(String name, long maxLatency, boolean disableChaining) {
		return beginLatencyConstraintBefore(new NamedConstraintGroupIdentifier(name), maxLatency, disableChaining);
	}


	private DataStream<OUT> beginLatencyConstraintBefore(ConstraintGroupIdentifier identifier, long maxLatency,
			boolean disableChaining) {

		ConstraintGroupConfiguration constraintGroupConfiguration = new ConstraintGroupConfiguration(identifier);
		constraintGroupConfiguration.getStart().setSourceId(getId());
		constraintGroupConfiguration.setMaxLatency(maxLatency);
		constraintGroupConfiguration.setDisableChaining(disableChaining);

		streamGraph.beginLatencyConstraint(constraintGroupConfiguration);
	 ...
	 * @return The {@link DataStream}.
	 */
	public DataStream<OUT> finishLatencyConstraintBefore() {
