...
public class DataStream<OUT> {
	...
	public DataStream<OUT> beginLatencyConstraint(long maxLatency) {
		return beginLatencyConstraint(maxLatency, -1);
	}
	 ...
	 * 		the desired maximum latency.
	 * @param gate
	 * 		the output gate of the source vertex of the begin end
	 * @return The {@link DataStream}.
	 */
	public DataStream<OUT> beginLatencyConstraint(long maxLatency, int gate) {
		return beginLatencyConstraint(maxLatency, gate, new AutoGeneratedConstraintGroupIdentifier());
	}
	 ...
	 * @return The {@link DataStream}.
	 */
	public DataStream<OUT> beginLatencyConstraint(long maxLatency, String name) {
		return beginLatencyConstraint(maxLatency, -1, new NamedConstraintGroupIdentifier(name));
	}
	 ...
	 * @return The {@link DataStream}.
	 */
	public DataStream<OUT> beginLatencyConstraint(long maxLatency, int gate, String name) {
		return beginLatencyConstraint(maxLatency, gate, new NamedConstraintGroupIdentifier(name));
	}

	private DataStream<OUT> beginLatencyConstraint(long maxLatency, int gate, ConstraintGroupIdentifier identifier) {
		...
		constraintGroupConfiguration.getStart().setOutputGate(gate);
	...
	/**
	 * Mark the end of the named opened latency constraint.
	 *
	 * @param name the name of the constraint to finish.
	 *
	 * @return The {@link DataStream}.
	 */
	public DataStream<OUT> finishLatencyConstraint(String name) {
		streamGraph.finishLatencyConstraint(getId(), new NamedConstraintGroupIdentifier(name));
		return this;
	}
